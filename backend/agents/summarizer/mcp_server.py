#!/usr/bin/env python3
"""MCP dispatch server for the Summarizer agent: routes tool/call requests to mcp_tools
...
from agents.summarizer.mcp_tools import TOOL_REGISTRY  # noqa: E402

logger = logging.getLogger('SummarizerMCPServer')
