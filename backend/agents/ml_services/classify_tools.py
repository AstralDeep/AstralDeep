#!/usr/bin/env python3
"""CLASSify tool slice for the ML Services agent:
submit/configure/train/poll/fetch-results/delete against a user's CLASSify deployment
via _wrapper.py's ExternalServiceClient; merged into the union registry by
mcp_tools.py.
"""
import json
...
# Caches identities only — every reuse re-checks ownership, not paths
