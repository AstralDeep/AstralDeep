"""Tests for orchestrator/ui_designer.py's device-fit objectives: the flag-gated ranking
bias in design_round, device-friendly arrangement selection, fail-open on scorer
errors, and connecting-device wiring from the orchestrator.
"""
