"""Tests for native-origin designed canvases (orchestrator/ui_designer.py,
orchestrator.py) under FF_DESIGNER_ALL_DEVICES: the post-done coalesced designer
pass, layout persistence, stale-turn guarding, and the flag-off native skip.
"""
