"""Tests for orchestrator/projection_surfaces/workspace_timeline.py over a real
Postgres-backed WorkspaceManager and HistoryManager: snapshot listing, historical
view rendering, and live-restore fan-out.
"""
...
async def test_live_without_any_chat_skips_canvas_render(env):
    ...
    chrome = _msgs(orch, "chrome_render")
    assert chrome and chrome[-1]["html"] == ""
