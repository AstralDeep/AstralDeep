"""Tests for component_action's remaining gaps (backend/orchestrator/orchestrator.py):
unsupported-kind refusal, the table_paginate-to-component_action alias, per-chat lock
serialization, and per-device ui_upsert adaptation.
"""
