"""Tests for orchestrator/local_agents.py: in-process built-in agent dispatch through a
LoopbackSocket, instantiation without uvicorn, and agent-side credential decryption;
dice_roller is the dependency-free built-in agent used.
"""
