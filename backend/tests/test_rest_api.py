"""Tests for the REST API (orchestrator/api.py): OpenAPI schema,
chat/component/agent/dashboard endpoints, auth enforcement, permission and
tool-selection endpoints, drafts, and A2A agent-key validation.
"""
