"""Tests for turn-boundary workspace snapshots (orchestrator/orchestrator.py,
workspace.py): _send_or_replace_components' op output, the one-snapshot-per-turn
contract, and chat/message-delete cascade behavior.
"""
