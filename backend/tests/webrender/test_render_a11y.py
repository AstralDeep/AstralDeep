"""Tests for accessibility of server-rendered primitives (AstralProjection
backend/webrender, webrender/sanitize.py): generated roles/names for charts, tables,
and metrics, and that only allowlisted attributes pass through.
"""
