"""Tests that ROTE degrade/collapse rebuilds preserve component identity
(AstralProjection backend/rote/adapter.py, capabilities.py): clients key canvases by
component_id, and morphed components keep it.
"""
