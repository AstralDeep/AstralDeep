"""Tests for voice_agent/session.py's first conversational turn over direct RTC: connect
reconciliation, VAD hysteresis/pre-roll, capture gating, and content-free failure
handling.
"""
